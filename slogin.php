...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = 'SELECT * from salon WHERE username=:username';
      ...
      if ($stmt->rowCount() === 1) {
        if ($row = $stmt->fetch()) {
          ...
          if ($cpassword === $pass) {
            ...
            $_SESSION['salonname'] = $row['salonname'];
            $_SESSION['id'] = $row['id'];
